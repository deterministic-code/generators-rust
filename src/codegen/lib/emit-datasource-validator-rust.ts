...
import {
  ...
  isFiniteInt,
  isFiniteNumber,
} from "@deterministic-code/generator-sdk/emitter-shared";
import type {
  DatasourceValidatorEmitConfig,
  EmittedFile,
  ValidatorFieldDef,
} from "@deterministic-code/generator-sdk/codegen/lib/datasource-validator-emit-types";
...
export const createEmitter = () => {
  ...
  return {
    emit: (config: DatasourceValidatorEmitConfig) =>
      base.emit({
