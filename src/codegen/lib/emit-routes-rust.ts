...
function emitCrudRouterContent(args: CrudRouterArgs): string {
...
function emitCrudRouterPlain(ctx: CrudRouterCtx): string {
...
function emitReadOnlyRouterContent(
  name: string,
  byFields: unknown,
  opts: RustRouteOpts,
): string {
...
export function emitCustomRouteStub(): null {
  return null;
}
