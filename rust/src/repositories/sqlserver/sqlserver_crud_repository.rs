...
#[async_trait]
impl Repository for SqlserverCrudRepository {
...
#[async_trait]
impl CrudRepository for SqlserverCrudRepository {
    async fn find(&self, _id: &Value) -> Result<Option<RowMap>, RepositoryError> {
        Err(RepositoryError::Unimplemented(
            "SqlserverCrudRepository runtime methods pending tiberius wiring",
        ))
    }
