...
function generateMethodImpl(serviceName, method, responseSample) {
...
function generateInvokeArm(method) {
...
export function generateGenericService(candidate, options = {}) {
    if (!candidate || typeof candidate.name !== "string") {
        throw new Error("generate-services-rust.generateGenericService: candidate.name (snake_case entity) is required");
    }
