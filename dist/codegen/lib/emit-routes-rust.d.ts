...
interface RustEmitOptions extends NamesForOptions {
...
export declare function emitReadOnlyRouter(candidate: RustRouteCandidate, options?: RustEmitOptions): EmittedFile;
export declare function emitCrudRouter(candidate: RustRouteCandidate, options?: RustEmitOptions): EmittedFile;
export declare function emitCustomRouteStub(): null;
...
export declare function emitAppWiring(wiring: AppWiringInput, options?: RustEmitOptions): EmittedFile;
