...
function generateSetupFn(entityName) {
...
function generateRegularEntityTests(entityName, typeDef, missingSegment) {
...
function generateReadonlyEntityTests(entityName, missingSegment) {
    const pascal = pascalize(entityName);
    const segment = pathSegmentFor(entityName);
    return `#[tokio::test]
async fn ${entityName}_list_returns_200() {
...
export function generateAppE2ETest({ datasourceData, datasourceSettings, }) {
