...
import { buildViewGenerator, classifyViewShape, declaredFieldsOf, shapedViewDocLines, unionViewDocLines, } from "@deterministic-code/generator-sdk/codegen/lib/generate-view-shared";
...
function inheritedDatasourceFields(datasource, tableName, ds) {
    ...
    if (!entry) {
        ...
        throw new Error(`generate-view-rust: view inherits datasource_types.${tableName} but no such type in datasource. Available: ${available || "(none)"}.`);
    }
